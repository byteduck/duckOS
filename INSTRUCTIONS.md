...
2. Run `sudo make get_image` to make the root filesystem get_image. (This must be run as root)
...
4. Run `make qemu-get_image` to run qemu with the get_image you just made.
5. Enjoy!